...
| Source | API / Dataset |
|---|---|
| CPCB CAAQMS live data | cpcb.nic.in/real-time-data |
| Sentinel-2 satellite | Copernicus Browser |
| IMD meteorological forecasts | mausam.imd.gov.in |
| OpenAQ (historical) | openaq.org/api |
| OSM land use (ward boundaries) | overpass-api.de |
